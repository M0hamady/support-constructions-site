...
const Nav: React.FC = () => {
  ...
  return (
    <nav className="bg-[#DCE4EC] text-[#333f4b] px-4 fixed bottom-0 w-full md:hidden">
      {/* Mobile Only Layout */}
      <div className="w-full h-[]  justify-between items-center gap-2.5 inline-flex flex-row-reverse px-4">
        {links.map((link, index) => (
          <div key={index} className="flex-col justify-center items-center text-center flex ">
            ...
            <div className="h-[45px] text-[#333f4b] text-[16px] font-medium font-['Cairo'] leading-[49px]">
